<template>
  <div>
    ...
    <div class="title-frame mt-3">
      ...
      <select class="toggle-btn" @change="toggleListGrid">
    ...
    <div v-show="showList" class="celeb-list-container">
      <div
        class="col-xl-9 col-md-11 m-auto mt-3 mb-3"
        v-for="(celeb, i) in celebArrRes"
        :key="i"
      >
        <celebrityFrameList
...
export default {
  ...
  methods: {
    ...
    toggleListGrid(event) {
      const value = event.target.value;
      this.displayList = value === "changeList";
